...
export default function History() {
  return (
    <section className="px-8 sm:px-12 py-26">
      <div className="max-w-2xl mx-auto relative">
        <h2 className="text-xl md:text-2xl font-bold italic mb-3.5">
          Our History
        </h2>
        ...
        <div>
          <img
            ...
            className="h-65 w-65 object-cover rounded-md shadow-lg"
          />
        </div>
        ...
        {/* Floating bean */}
        <div className="absolute -bottom-12 -right-4 md:-left-14 opacity-70 float">
          <BeanFloat />
        </div>
      </div>
    </section>
